...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' 'Racol')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|racol|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/Racol/all) ColorSchemes version
